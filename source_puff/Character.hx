...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'puff':
				frames = Paths.getSparrowAtlas('puffpuff/puffpuff_assets');
				animation.addByPrefix('idle', 'Puff idle dance', 24);
				animation.addByPrefix('singUP', 'Puff Sing Note UP', 24, false);
				animation.addByPrefix('singDOWN', 'Puff Sing Note DOWN', 24, false);
				animation.addByPrefix('singLEFT', 'Puff Sing Note LEFT', 24, false);
				animation.addByPrefix('singRIGHT', 'Puff Sing Note RIGHT', 24, false);
				...
				addOffset("singUP-alt", 0, 50);
				addOffset("singRIGHT-alt", 0, 50);
				addOffset("singLEFT-alt", 0, 50);
				addOffset("singDOWN-alt", 0, 50);
				playAnim('idle');
		}
